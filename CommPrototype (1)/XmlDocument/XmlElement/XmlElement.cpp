...
int main()
{
  ...
  sPtr root = makeTaggedElement("meta");
  //root->addChild(makeTextElement("this is a test");

  sPtr child = makeTaggedElement("title");
  child->addChild(makeTextElement("XML Example #1"));
  root->addChild(child);

  sPtr child2 = makeTaggedElement("dependency");
  root->addChild(child2);
  sPtr name1 = makeTaggedElement("name1");
  name1->addChild(makeTextElement("A.cpp"));
  sPtr name2 = makeTaggedElement("name2");
  name2->addChild(makeTextElement("A.h"));
  child2->addChild(name1);
  child2->addChild(name2);

  sPtr status = makeTaggedElement("status");
  status->addChild(makeTextElement("1"));
