...
void ConfigParseToConsole::ScopeBuild()
{
	...
	// configure to detect and act on nonstatic function definitions// these will stop further rule checking by returning false
	...
	pPushStaticFunction = new PushStaticFunction(pRepo);
	pPrintStaticFunction = new PrintStaticFunction(pRepo);
